...
tmux send -t "test-dvroute":0.0 "$PYTHON $SRC/ls_router.py" Enter
tmux send -t "test-dvroute":0.1 "$PYTHON $SRC/ls_router.py" Enter
tmux send -t "test-dvroute":0.2 "$PYTHON $SRC/ls_router.py" Enter
tmux send -t "test-dvroute":0.3 "$PYTHON $SRC/ls_router.py" Enter
tmux send -t "test-dvroute":0.4 "$PYTHON $SRC/ls_router.py" Enter
tmux send -t "test-dvroute":0.5 "$PYTHON $SRC/ls_router.py" Enter
