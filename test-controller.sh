...
tmux send -t "test-controller":0.3 '0' Enter
tmux send -t "test-controller":0.3 'y' Enter
tmux send -t "test-controller":0.3 'Hello, World!' Enter
tmux send -t "test-controller":0.3 '127.0.0.1' Enter
tmux send -t "test-controller":0.3 '9002'
